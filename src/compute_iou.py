...
def main(args):
    ...
    data_loader = DataLoader(src_path, points_per_object=1, click_area=click_area, normalize_colors=True, downsample=downsample, limit_to_one_object=limit_to_one_object)
